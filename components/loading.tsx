...
export default function LoadingContent({ loading, children }: PropsWithChildren<{ loading: boolean }>) {
    ...
    return (
        <div className="w-full h-full py-10 flex justify-center items-center">
            <svg className="animate-spin -ml-1 mr-3 h-7 w-7 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="#CCC" strokeWidth="4"></circle>
